...
public class TUIOClient {
	...
	public void removeTuioObject(TuioObject tobj) {
		...
		listener.trackingEvent(new TrackingInfo(TrackingInfo.REMOVE,tobj.getSessionID(), tobj.getScreenX(MainHandler.screenWidth), tobj.getScreenY(MainHandler.screenHeight)));
	}

	// called when an object is moved
	public void updateTuioObject(TuioObject tobj) {
		//System.out.println("updateTuioObject");
		listener.trackingEvent(new TrackingInfo(TrackingInfo.UPDATE,tobj.getSessionID(), tobj.getScreenX(MainHandler.screenWidth), tobj.getScreenY(MainHandler.screenHeight)));
	}
